...
public class NewAvgDataSimple {
    ...
    NewAvgDataSimple(List<NewEvaluationExcel> newEvaluationExcels) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 初始化计算平均分对象
        NewAvgDataSimple evaluationData = new NewAvgDataSimple(newEvaluationExcels);
